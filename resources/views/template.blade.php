...
<head>
    ...
    <title>Расцвет - онлайн магазин цветов города Минусинска</title>
...
<div class="main-wrapper">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="header-middle-wrap position-relative">
                            ...
                            <a class="header-logo col-lg-2 col-6">
                                <img src="assets/images/logo/test logo 2.png" alt="Header Logo">
                            </a>
                ...
                <div class="header-nav position-relative">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-6">
                            ...
                            <a class="header-logo col-lg-5 col-6">
                                <img src="assets/images/logo/test logo 2.png" alt="Header Logo">
                            </a>
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown d-none d-lg-block">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="stickysettingButton">
                                            <li><a class="dropdown-item" href="/prodile">Профиль</a></li>
                                            <li><a class="dropdown-item" href="/login">Войти</a></li>
                                            <li><a class="dropdown-item" href="/register">Зарегистрироваться</a></li>
                                        </ul>
                                    </li>
                        ...
                        <ul class="dropdown-wrap">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="settingButtonTwo">
                                    <li><a class="dropdown-item" href="/profile">Войти</a></li>
                                    <li><a class="dropdown-item" href="/login">Войти</a></li>
                                    <li><a class="dropdown-item" href="/register">Зарегистрироваться</a></li>
                                </ul>
                            </li>
    ...
    <!-- Main Header Area End Here -->
        @yield('content')
    <!-- Begin Footer Area -->
    <div class="footer-area" data-bg-image="assets/images/footer/bg/1-1920x465.jpg" style="background-image: url(&quot;assets/images/footer/bg/1-1920x465.jpg&quot;);">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="footer-widget-item">
                            <div class="footer-widget-logo">
                                <a>
                                    <img src="assets/images/logo/test logo 3.png" alt="Logo">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4 pt-40">
                        <div class="footer-widget-item">
                            <h3 class="footer-widget-title">Компания</h3>
